...
const content = {
  es: {
    ...
    historyP1: "PLUS BI se conformó en 2021, y ya el primer día algo hizo click. Descubrimos que nuestras perspectivas no solo se complementaban, sino que se potenciaban. Hoy, somos un equipo unido por una <strong>convicción profunda</strong>: cada avance hacia una gestión pública más transparente y participativa es un paso hacia una sociedad más justa.",
